...
<!-- modal detail -->
<div class="modal fade bd-example-modal-lg" id="retur" tabindex="-1" role="dialog" aria-labelledby="returLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="returLabel"></h5>
            </div>
            <div class="modal-body">
                <div class="row mt-1">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <video id="video_response" width="300" src="" controls></video>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    $(document).ready(function() {
       ...
       <tr>
        ...
        // modal retur
        $('body').on('click', '#btnRetur', function() {
            var data_id = $(this).data('id');
            $.get('pengiriman/' + data_id + '/edit/', function(data) {
                console.log(data);
                $('#returLabel').html("Detail Retur");
                $('#retur').modal('show');
                $('#video_response').prop('src','https://tokobonafide.store/public/video/retur/'+data.video_response);
            })
        });
    });
</script>
